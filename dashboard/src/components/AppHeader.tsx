...
export function appHeaderActionClassName({
  ...
  return classes(
    'harness-e2e-header-action inline-flex min-h-7 shrink-0 items-center justify-center rounded-[6px] border-0 bg-transparent px-2.5 font-mono text-[12px] font-medium lowercase leading-none text-ink-soft no-underline transition-colors duration-150 ease-in-out',
    primary
