...
describe('ScenarioMatrix', () => {
  it('renders a comparable matrix with an inline workflow expansion', () => {
    ...
    expect(html).toContain('advisory quality')
    ...
    expect(html).toContain('data-primary-metric="Duration"')
    expect(html).toContain('data-primary-metric="Tokens"')
    expect(html).toContain('data-primary-metric="Function calls"')
    expect(html).toContain('data-primary-metric="Cost"')
