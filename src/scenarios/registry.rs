...
fn spec<const N: u8>(run_id: &str) -> ScenarioSpec {
    ...
    ScenarioSpec {
        ...
        execution: ExecutionPolicy { max_turns: Some(128), max_output_tokens: Some(32_768), max_total_tokens: Some(if N == 2 { 1_200_000 } else { 600_000 }), stuck_timeout_seconds: Some(900), max_validation_retries: None },
        denied_functions: &[],
